...
from processing_functions import tweak, tweak_profile, tweak_proxy,tweak_redirect,tweak_content,get_list_of_intersection, tweak_search
...
def main()-> None:
    ...
    for ies in ies_lst:
        ...
        #                     ies=ies,
        #                     processing_function=tweak_search,
        #                     fact='Busquedas',
